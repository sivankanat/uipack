...
var docsEl = document.querySelector('.sidebar-nav li.docs ul.child');
var cls = "";

for (var _i = 0, _Object$entries = Object.entries(pages.over); _i < _Object$entries.length; _i++) {
...
for (var _i2 = 0, _Object$entries2 = Object.entries(pages.docs); _i2 < _Object$entries2.length; _i2++) {
  var _Object$entries2$_i = _slicedToArray(_Object$entries2[_i2], 2),
      _key = _Object$entries2$_i[0],
      _val = _Object$entries2$_i[1];

  window.location.pathname.includes(_val) ? cls = " class='active' " : '';
  docsEl.innerHTML += "<li ".concat(cls, "><a href=\"").concat(_val, "\">").concat(_key, "</a></li>");
  cls = '';
}
