...
document.querySelectorAll('.uipack-scenario').forEach(function (e) {
  ...
  var scenarioCont = "<div class=\"uipack-scenario\" data-live=\"false\" flex=\"\">\n                      <nav class=\"wd:a\">\n                      <div class=\"sticky-nav scenario-tab\"><span class=\"active\" data-tab=\"preview\">Preview</span><span                       data-tab=\"source\">Source</span></div></nav>\n                      <div class=\"scenario-list expand\">\n                      <div class=\"preview active\" animate=\"to-left\">".concat(html, "</div>\n                      <div class=\"source\" animate=\"to-left\"><pre><code class=\"language-html\"><xmp>").concat(html, "</xmp></code></pre>\n                      </div></div></div>");
...
document.querySelectorAll('.uipack-scenario').forEach(function (scenario) {
  scenario.querySelectorAll('nav span').forEach(function (e, i) {
    e.addEventListener('click', function () {
      ...
      scenario.querySelector(".scenario-list .".concat(dataTab)).classList.add('active');
    });
  });
});

function scenario_reset(sc) {
  sc.querySelectorAll('.scenario-tab span').forEach(function (e) {
    return e.classList.remove('active');
  });
  sc.querySelectorAll('.scenario-list > div').forEach(function (e) {
    return e.classList.remove('active');
  });
}
